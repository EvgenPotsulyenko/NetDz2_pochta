Используя класс Socket реализовать клиент-серверное приложение, которое позволяет клиенту по почтовому индексу получить список улиц, соответствующих этому индексу. Данные об 
